...
public class LiveViewDemo extends JFrame {
  ...
  private void intGui() {
    ...
    javax.swing.GroupLayout jPanTopLayout = new javax.swing.GroupLayout(jPanTop);
    jPanTop.setLayout(jPanTopLayout);
    jPanTopLayout.setHorizontalGroup(
        jPanTopLayout
    ...
    jPanTopLayout.setVerticalGroup(
        jPanTopLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                jPanTopLayout
    ...
    javax.swing.GroupLayout imageLiveLayout = new javax.swing.GroupLayout(imageLive);
    imageLive.setLayout(imageLiveLayout);
    imageLiveLayout.setHorizontalGroup(
        imageLiveLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE));
    imageLiveLayout.setVerticalGroup(
        imageLiveLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 249, Short.MAX_VALUE));

    javax.swing.GroupLayout jPanLiveAreaLayout = new javax.swing.GroupLayout(jPanLiveArea);
    jPanLiveArea.setLayout(jPanLiveAreaLayout);
    jPanLiveAreaLayout.setHorizontalGroup(
        jPanLiveAreaLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                imageLive,
            ...
            .addGroup(
                jPanLiveAreaLayout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jSliderZoom, javax.swing.GroupLayout.DEFAULT_SIZE, 700, Short.MAX_VALUE)));
    jPanLiveAreaLayout.setVerticalGroup(
        jPanLiveAreaLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                javax.swing.GroupLayout.Alignment.TRAILING,
    ...
    javax.swing.GroupLayout imageShootLayout = new javax.swing.GroupLayout(imageShoot);
    imageShoot.setLayout(imageShootLayout);
    imageShootLayout.setHorizontalGroup(
        imageShootLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE));
    imageShootLayout.setVerticalGroup(
        imageShootLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE));
  ...
  public void initActions() {
    ...
    try {
      ...
      jBtnDisconnect.addActionListener(
          new ActionListener() {
  ...
  private class LiveCapture implements Runnable {
    ...
    public void run() {
      while (isConnected) {
        ...
        visorImage =
            resizeImage(visorImage, (int) (visorImage.getHeight() * 1.5), visorImage.getHeight());
