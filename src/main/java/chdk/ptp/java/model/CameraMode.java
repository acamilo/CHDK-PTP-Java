 ...
 *     set_record(0)</a>
 * @see <a href="http://chdk.wikia.com/wiki/Lua/Lua_Reference#get_mode">CHDK get_mode)</a> first
 *     param
...
public enum CameraMode {
  ...
  /**
   * @param camMode value of first parameter returned by @see <a
   *     href="http://chdk.wikia.com/wiki/Lua/Lua_Reference#get_mode" >CHDK get_mode)</a>
