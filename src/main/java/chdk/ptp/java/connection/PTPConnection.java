...
public class PTPConnection {
  ...
  public PTPConnection(UsbEndpoint camIn, UsbEndpoint camOut)
      throws CameraConnectionException, UsbNotActiveException, UsbNotClaimedException,
    ...
    PTPPacket p =
        new PTPPacket(
            ...
            PTPPacket.PTP_OPPCODE_OpenSession,
            0,
  ...
  public PTPPacket getResponse()
      throws CameraConnectionException, InvalidPacketException, PTPTimeoutException {
  ...
  public void close()
      throws UsbNotActiveException, UsbNotOpenException, UsbDisconnectedException, UsbException {
