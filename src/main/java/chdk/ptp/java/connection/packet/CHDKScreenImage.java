...
public class CHDKScreenImage extends Packet{
	...
	private static final int iViewDataHeaderViewportDescriptorStart= 20; // in-chdk.ptp.java.connection.packet pointer to viewport descriptor (ui overlay)
	private static final int iViewDataHeaderBitmapDescriptorStart= 24; // in-chdk.ptp.java.connection.packet-pointer to bitmap descriptor (image)
